...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="#top" class="active">Masalah</a></li>
                            <li class="scroll-to-section"><a href="#services">Solusi</a></li>
                            ...
                            <li class="scroll-to-section">
                                <div class="main-red-button"><a
                                        href="https://wa.me/62895621078095?text=Saya%20butuh%20layanan%20asisten%20marketing">Hubungi</a>
                                </div>
                            </li>
                        </ul>
    ...
    <script src="{{ asset('clients/assets/js/animation.js') }}"></script>
